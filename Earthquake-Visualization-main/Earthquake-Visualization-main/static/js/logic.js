...
// Reading in GeoJSON data through query URL
d3.json(queryUrl, function(data) {
  // Pass through data into createFeatures function
  createFeatures(data.features);
});

// Define a Function for colour Scale
function colors(d) {
...
function createMap(earthquakes) {
  ...
  // Create our map, adding the darkmap, earthquakes, and tectonic plate layers
    var myMap = L.map('map', {
  ...
  // Create a layer control and pass in the base/overlay maps
...
// Define a function to add features of earthquake data to map
